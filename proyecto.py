...
def seleccionar(modeloL):
  ...
  clase_trabajo=st.sidebar.slider("Seleccion", 1, 100,5,2)
...
modelo,edad, clase_trabajo, num_educacion ,estado_civil, ocupacion, relacion,raza, sexo, horas_por_semana,pais_natal=seleccionar(modeloA)
...
with st.container(border=True):
  ...
  lista=[[edad, clase_trabajo, num_educacion ,estado_civil, ocupacion, relacion,raza, sexo, horas_por_semana,pais_natal]]
  ...
  col1.metric(label="Probalidad de SI :", value="{0:.2%}".format(probabilidad[0][0]),delta=" ")
  col2.metric(label="Probalidad de NO:", value="{0:.2%}".format(probabilidad[0][1]),delta=" ")
